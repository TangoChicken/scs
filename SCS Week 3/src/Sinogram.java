...
//				sinogramFTRe[iTheta][iK] *= clippedCosine;
//				sinogramFTIm[iTheta][iK] *= clippedCosine;
			}
		}
...
//        F... do 1D FFT on a row ...
		...
		DisplayDensity display6 = new DisplayDensity(sinogramFTRe, N, "Filtered sinogram");

		DisplayDensity display5 = new DisplayDensity(backProjection, N, "Back projected sinogram"/*, GREY_SCALE_LO,
				GREY_SCALE_HI*/);
	}
